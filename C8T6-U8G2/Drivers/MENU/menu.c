...
int getFrameWidth(u8g2_t *u8g2) {
    ...
    switch (state) {
        ...
        case Update_Menu:
            ...
            break;
        case About_Menu:
            Width = u8g2_GetStrWidth(u8g2, allMenu[11][num].label) + suitable_len;
            break;
        default:
            break;
    }
...
void scrollMenu(u8g2_t *u8g2) {
    if (state == Main_Menu) {
        /*---------num can be calculated, or you set it */
        ...
        int num = sizeof(allMenu[11]) / sizeof(allMenu[11][0]);
        printMenu(u8g2, allMenu[11], num, &MenuStart);
    }
}
